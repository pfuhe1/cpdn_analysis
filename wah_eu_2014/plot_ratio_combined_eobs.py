...
from region_returntimes import get_region_returntimes, remap_p5deg_to_rotated2,remap_1deg_to_rotated,ave_bias
...
#	obs=obs_file.variables['temperature'][-12:,:,:].mean(0)
	...
	obs=anom-ref
	# Regrid obs
	obs=remap_p5deg_to_rotated2(obs,'/home/cenv0437/tas_clim_1960-1990.nc',obs_fillvalue)
	...
	# ratio
	ratio2014=((count_hist)/(count_nat+1.e-16)) 
	ratioclim=((count_clim_hist)/(count_clim_nat+1.e-16)) 
...
#	c.cmap.set_under('b')
	...
	plt.savefig(folder+'ratio_combined_eobs.png')
