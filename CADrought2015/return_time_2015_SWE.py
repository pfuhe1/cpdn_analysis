...
#	allf_mec="MediumBlue"
	...
	ax.set_ylabel("Total snow amount exceeding this amount (mm)",fontsize=16)
	...
	ax.set_title("California Snow Amount - "+str(nsims)+" Simulations")
...
#	ax.set_ylim(0,ymax) #0,450
	...
	plt.legend(loc='best')
	fname_out="return_time_swe_pnw_test.png"
...
def main():
	...
	return_time_swe(swe_allforc,swe_clim,swe_nat)
