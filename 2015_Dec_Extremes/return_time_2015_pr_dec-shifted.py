...
def return_time_pr(fig,datad,mecs,cols,region,fname_out=False):
	...
	ax.set_title(region+" Dec 10 - Jan 9 Precipitation\n")
...
def main():
	...
	f_pickle=pkl_dir+'/pr_results_dec-shifted_'+region+'.pkl'
...
# 					print os.path.basename(fname2)
# 					tmp[i*30:(i+1)*30]=region_mean2(region,netcdf_file(fname2,'r').variables['field90'][:,0,:],lat_coords,lon_coords)*60*60*24
# 				data_clim[umid]=tmp[9:40].mean(0)		
# 		except Exception,e:
# 			print "Error loading files",e
# 			continue
...
#			print '2015 event'
	...
	fout='/home/cenv0437/cpdn_analysis/2015_Dec_Extremes/figs/pr_return_dec-shifted_'+region+'_uncorrected'
	# Make still image
	f_ext='.png'
